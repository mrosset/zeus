...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.{{.ShortName}}.yaml)")
	rootCmd.PersistentFlags().String("prefix", filepath.Join(home, "zeus"), "Directory zeus programs are to be installed")
